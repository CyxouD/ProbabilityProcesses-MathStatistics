...
import primary_statistical_analysis.Main
import primary_statistical_analysis.TableDisplaying
 ...
 */
object TableDisplaying : JPanel() {
    fun samplingCharacteristics(points2d: Array<List<Double>>, mistakeProbability: Double)
            : TableDisplaying {
