...
class TestMeansEqualityTwoSampleTTest {
    ...
    fun testSignificanceWithSameSamples() {
        val meansEqualityTwoSampleTTest = sample_uniformity.MeansEqualityTwoSampleTTest(sampleFirst100Elements, sampleFirst100Elements)
    ...
    fun testSignificanceWithAlmostSameMean() {
        val meansEqualityTwoSampleTTest = sample_uniformity.MeansEqualityTwoSampleTTest(sampleFirst100Elements, sampleSecond100Elements)
        val actualValue = meansEqualityTwoSampleTTest.isCriterionTrue(0.05)
        assertEquals(true, actualValue)
    }
    ...
    fun testStatisticsWithAssumptionOfNotEqualVariance() {
        val meansEqualityTwoSampleTTest = sample_uniformity.MeansEqualityTwoSampleTTest(usaGallonPerMile, japanGallonPerMile)
        val actualValue = java.math.BigDecimal(meansEqualityTwoSampleTTest.statistics).setScale(5, java.math.BigDecimal.ROUND_HALF_EVEN)
        val wantedValue = java.math.BigDecimal.valueOf(-12.94627)
